    ...
    <el-dialog
      ...
      >
           <el-form :model="ruleFormfakaClass" ref="ruleFormfakaClass" :rules="rulesfakaClass" label-width="100px" label-position="right">
                    ...
                    <el-form-item label="购买金额："  v-if="ruleFormfakaClass.CardID>0 &&showPurchaseAmount" prop="PurchaseAmount" >
                        <el-input v-model="ruleFormfakaClass.PurchaseAmount" placeholder="购买金额" style="width:100px;"></el-input> 元
                    </el-form-item>
