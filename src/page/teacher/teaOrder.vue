      ...
      <!-- <span @click="getNow">回到今天</span> -->
        ...
        <div style="margin-bottom:10px;">
          <van-dropdown-menu active-color="#1989fa">
            ...
            <van-dropdown-item v-model="ClassTeacher" :options="Teacherlist" v-if="isTeacher =='0' " @change="changeOptions"/>
          </van-dropdown-menu>
...
<!--             </el-select> &nbsp;-->
<!--         <el-select  clearable v-model="ClassTeacher" style="width:150px;" v-if="isTeacher =='0' "    placeholder="请选择老师" >-->
