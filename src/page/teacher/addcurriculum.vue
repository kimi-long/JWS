   ...
   <el-form :model="ruleForm" ref="ruleForm" :rules="rules" label-width="120px" label-position="right">
                    ...
                    <el-form-item label="预约方式：" prop="preAboutType">
                        <el-radio-group v-model="RowClassType" >
                            <el-radio label="0">课程课表</el-radio>
                            <el-radio label="1">私教</el-radio>
                         </el-radio-group>
                    </el-form-item>
                    <el-form-item label="周期：" prop="Cycle"  >
                        <el-checkbox-group v-model="checkedCycles" @change="handleChange">
                            <el-checkbox v-for="item in CycleList" :label="item.Id" :key="item.index" name="Cycle">
                                {{item.Label}}
                            </el-checkbox>
                        </el-checkbox-group>
                    </el-form-item>
                    <el-form-item label="课表期限：" prop="startTimes">
                       
                        <el-input  type="date" v-model="ruleForm.startTimes" placeholder="开始日期"> </el-input>
                        <span > 至 </span>
                        
                       <el-input  type="date" v-model="ruleForm.endTimes" placeholder="结束日期"> </el-input>

                    </el-form-item>
                    <el-form-item label="老师：" prop="LoginID">
                        <el-select v-model="ruleForm.LoginID" filterable placeholder="搜索老师名">
                            <el-option v-for="item in teacherList" :value="item.ID" :label="item.Name" :key="item.index">
                            </el-option>
                        </el-select> 
                    </el-form-item>
                    <el-form-item label="课程：" prop="CourseID">
                        <el-select filter v-model="ruleForm.CourseID" filterable  placeholder="搜索课程名">
                    ...
                    <el-form-item label="课程时长：" prop="Timelength" >
                        <el-input v-model="ruleForm.Timelength" placeholder="课程时长" style="width:150px;"></el-input> 分钟
                    </el-form-item>
                    ...
                    <el-form-item v-if="RowClassType=='0'" label="开始时间：" prop="startTime">
                       ...
                       <el-form-item v-if="RowClassType=='0'" label="人数限制：" prop="limitCount">
                        <el-input v-model="ruleForm.limitCount" placeholder="请输入限制人数" style="width:150px;"></el-input> 人
                    </el-form-item>
                    <el-form-item label="预约方式：" prop="preAboutType">
                  ...
                  <el-form-item label="选定会员卡：" v-if="showAmemberCard" prop="AmemberCard">
                        <el-select style="width: 100%;" v-model="AmemberCards"  filterable multiple  @change="changeCardID" placeholder="请选择会员卡">
                    ...
                    <el-form-item label="消耗次数："  v-if="showConsumptionOfClass" prop="ConsumptionOfClass" >
                        <el-input v-model="ruleForm.ConsumptionOfClass" placeholder="消耗次数" style="width:100px;"></el-input> 次
                    </el-form-item>
                    <el-form-item label="消耗金额："  v-if="showsinglePrice" prop="singlePrice" >
                        <el-input v-model="ruleForm.singlePrice" placeholder="消耗金额" style="width:100px;"></el-input> 元
                    </el-form-item>
                    ...
                    <el-form-item  v-if="RowClassType=='0'" label="最低开课人数：" prop="MinCount">
                        <el-input v-model="ruleForm.MinCount" placeholder="可选" style="width:150px;"></el-input> 人
                    </el-form-item>
...
<script>
  import { stuGetListStoresName,getwxlistCourse,getListwxMemberCard,getListTeacher,addwxRowClass,getwxListLevel } from "@/api/getData";
    ...
    methods: {
       ...
       submitForm(){
            ...
            this.addwxRowClass();
                ...
                const crs = await addwxRowClass(this.ruleForm)
                // console.log(crs)
                if(crs.orsuccess == '1'){
