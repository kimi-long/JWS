   ...
   <el-form :model="ruleForm" ref="ruleForm" :rules="rules" label-width="120px" label-position="right">
                  ...
                  <el-form-item label="姓名：" prop="Name">
                   ...
                   <el-form-item label="性别：" prop="Sex">
                    ...
                    <el-form-item label="购买金额："  v-if="showPurchaseAmount  " prop="PurchaseAmount" >
                        <el-input v-model="ruleForm.PurchaseAmount" placeholder="购买金额" style="width:100px;"></el-input> 元
                    </el-form-item>
