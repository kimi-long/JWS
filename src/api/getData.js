...
export const getTerListClassJW = data => fetch('/getTerListClassJW.aspx',data, 'POST','true');
export const getTerListClassRowClass = data => fetch('/getTerListClassRowClass.aspx',data, 'POST','true');
export const getTerClassInfo = data => fetch('/getTerClassInfo.aspx',data, 'POST','true');
export const getListTerClassMembers = data => fetch('/getListTerClassMembers.aspx',data, 'POST','true');
export const getListTerCourseRowClass = data => fetch('/getListTerCourseRowClass.aspx',data, 'POST','true');
export const getlistTersumGoodsSell = data => fetch('/getlistTersumGoodsSell.aspx',data, 'POST','true');
export const getListsumPayroll = data => fetch('/getListsumPayroll.aspx',data, 'POST','true');
export const getTerlistPayroll = data => fetch('/getTerlistPayroll.aspx',data, 'POST','true');
export const getListTerXFTJ = data => fetch('/getListTerXFTJ.aspx',data, 'POST','true');
export const getListGoodsType = data => fetch('/getListGoodsType.aspx',data, 'POST','true');
export const getListGoods = data => fetch('/getListGoods.aspx',data, 'POST','true');
export const getwxterlistCourse = data => fetch('/getwxterlistCourse.aspx',data, 'POST','true');
export const getlsumGoodsSellInfo = data => fetch('/getlsumGoodsSellInfo.aspx',data, 'POST','true');
export const getTerXFTJinfo = data => fetch('/getTerXFTJinfo.aspx',data, 'POST','true');
