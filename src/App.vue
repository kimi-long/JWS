 ...
 * @LastEditTime: 2020-04-25 19:42:24
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \课程\src\App.vue
 -->
<template>
  <div id="app">
	  <head-top v-if="this.$route.name!= 'gzt'&&this.$route.name!= 'my'&&this.$route.name!= 'login2'
    &&this.$route.name!= 'dianPingPage'&&this.$route.name!= 'stuIndex'"></head-top>
    <router-view v-if="isRouterAlive"/>
    <lg-preview></lg-preview>
    <div v-if="isAllLoading" class="loading-container">
