...
import gzt from '@/page/gzt'
import my from '@/page/my'
import banjiList from '@/page/banjiList'
import kebiao from '@/page/kebiao'
import banjixueyuan from '@/page/banjixueyuan'
import xueshengguanli from '@/page/xueshengguanli'
import xiaoketongji from '@/page/xiaoketongji'
import shangpingxiaoshou from '@/page/shangpingxiaoshou'
import gongzimingxi from '@/page/gongzimingxi'
import xufeitongji from '@/page/xufeitongji'
import sellInfo from '@/page/sellInfo'
import xufeitongjiInfo from '@/page/xufeitongjiInfo'
...
export default new Router({
  routes: [
    ...
    },
    {
      path: '/banjixueyuan',
      name: 'banjixueyuan',
      component: banjixueyuan
    },
    {
      path: '/gongzimingxi',
      name: 'gongzimingxi',
      component: gongzimingxi
    },
    {
      path: '/xueshengguanli',
      name: 'xueshengguanli',
    ...
    {
      path: '/xufeitongjiInfo',
      name: 'xufeitongjiInfo',
      component: xufeitongjiInfo
    },
    {
      path: '/xiaoketongji',
      name: 'xiaoketongji',
      component: xiaoketongji
    },
    {
      path: '/shangpingxiaoshou',
      name: 'shangpingxiaoshou',
      component: shangpingxiaoshou
    },
    {
      path: '/xufeitongji',
      name: 'xufeitongji',
      component: xufeitongji
    },
    {
      path: '/teaOrder2',
      name: 'teaOrder',
